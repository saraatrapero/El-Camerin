...
const Hero: React.FC = () => {
  return (
    <section id="inicio" className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      {/* Background Image - Evoking Sierra Morena landscape at dawn */}
      <div 
        className="absolute inset-0 bg-cover bg-center z-0 scale-105 animate-slow-zoom"
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1500382017468-9049fee74a62?auto=format&fit=crop&q=80&w=1920')" }}
      >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl text-stone-200 mb-10 max-w-2xl mx-auto leading-relaxed font-light drop-shadow-md">
          Ocho siglos de fe, milagro y tradición en el corazón de Sierra Morena.
        </p>
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          ...
          >
            <span className="relative z-10">Conocer su Historia</span>
